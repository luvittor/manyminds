...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            echo form_dropdown("produtos_id", $produtos, ($campos_limpos ? "" : set_value("produtos_id")));
            echo form_label("Quantidade", "quantidade");
            echo form_input("quantidade", ($campos_limpos ? "" : set_value("quantidade")), ['placeholder' => '0']);
            echo form_label("Valor Unitário", "preco");
            echo form_input("preco", ($campos_limpos ? "" : set_value("preco")), ['placeholder' => '0,00']);
